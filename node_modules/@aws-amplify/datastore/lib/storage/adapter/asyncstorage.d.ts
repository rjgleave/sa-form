...
import { InternalSchema, ModelPredicate, NamespaceResolver, OpType, PersistentModel, PersistentModelConstructor, QueryOne, PaginationInput } from '../../types';
declare class AsyncStorageAdapter implements Adapter {
    private schema;
