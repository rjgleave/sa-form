...
import { NO_AUTH_MODULE_FOUND, COUNTRY_DIAL_CODE_DEFAULT, COUNTRY_DIAL_CODE_SUFFIX, PHONE_SUFFIX, } from '../../common/constants';
import { dispatchToastHubEvent, dispatchAuthStateChangeEvent, composePhoneNumberInput, checkUsernameAlias, isHintValid, } from '../../common/helpers';
...
export class AmplifySignIn {
    ...
    render() {
        return (h("amplify-form-section", { headerText: this.headerText, handleSubmit: this.handleSubmit, testDataPrefix: 'sign-in' },
    ...
    static get properties() { return {
        ...
        "headerText": {
            ...
            "reflect": false,
            "defaultValue": "I18n.get(Translations.SIGN_IN_HEADER_TEXT)"
        },
        "submitButtonText": {
            "type": "string",
            "mutable": false,
            ...
            "reflect": false,
            "defaultValue": "I18n.get(Translations.SIGN_IN_ACTION)"
        },
        "federated": {
            "type": "unknown",
            "mutable": false,
