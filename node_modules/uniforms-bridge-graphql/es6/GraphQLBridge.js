...
const extractFromNonNull = x => x && x.type instanceof graphql.GraphQLNonNull
    ? Object.assign(Object.assign({}, x), { type: x.type.ofType }) : x;
...
export default class GraphQLBridge extends Bridge {
    ...
    getProps(nameNormal, props = {}) {
        ...
        const ready = Object.assign(Object.assign({ required: field.type instanceof graphql.GraphQLNonNull }, this.extras[nameGeneric]), this.extras[nameNormal]);
